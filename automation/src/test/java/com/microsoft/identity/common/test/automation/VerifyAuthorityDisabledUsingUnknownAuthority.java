...
public class VerifyAuthorityDisabledUsingUnknownAuthority {
    ...
    public VerifyAuthorityDisabledUsingUnknownAuthority(String federationProvider){
    ...
    private static User getUser(TestConfigurationQuery query){
        ...
        //newUser.setAuthority("https://microsoft.sharepoint.com");
        return newUser;
    }
