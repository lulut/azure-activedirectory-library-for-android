...
public class SignInPage {
    ...
    public static Target SIGN_IN_BUTTON = Target.the("SignIn button").located(MobileBy.AndroidUIAutomator("new UiSelector().className(\"android.view.View\").instance(5)"));
