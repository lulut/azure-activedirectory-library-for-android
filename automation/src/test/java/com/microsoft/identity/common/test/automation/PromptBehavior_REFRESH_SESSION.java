...
import com.microsoft.identity.common.test.automation.tasks.AcquireTokenPBRefresh;
...
public class PromptBehavior_REFRESH_SESSION {
    ...
    @Steps
    AcquireTokenPBRefresh acquireTokenPBRefresh;
    ...
    public PromptBehavior_REFRESH_SESSION(String federationProvider){
